...
[![GitHub Issues](https://img.shields.io/github/issues/template-sync-cli/template-sync-cli.svg?style=flat-square)](https://github.com/template-sync-cli/template-sync-cli/issues)
[![Build Status](https://img.shields.io/endpoint.svg?url=https%3A%2F%2Factions-badge.atrox.dev%2Ftemplate-sync-cli%2Ftemplate-sync-cli%2Fbadge\&style=flat)](https://actions-badge.atrox.dev/template-sync-cli/template-sync-cli/goto)
[![Styled with prettier](https://img.shields.io/badge/styled_with-prettier-ff69b4.svg)](https://github.com/prettier/prettier)
[![Commitizen friendly](https://img.shields.io/badge/commitizen-friendly-brightgreen.svg)](http://commitizen.github.io/cz-cli/)
[![Known Vulnerabilities](https://snyk.io/test/github/template-sync-cli/template-sync-cli/badge.svg)](https://snyk.io/test/github/template-sync-cli/template-sync-cli)
[![Coverage Status](https://coveralls.io/repos/template-sync-cli/template-sync-cli/badge.svg)](https://coveralls.io/github/template-sync-cli/template-sync-cli)
